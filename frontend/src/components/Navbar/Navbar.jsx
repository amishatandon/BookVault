  ...
  return (
    <div className="flex bg-zinc-800 text-white px-8 py-4 items-center justify-between">
      <div className="flex items-center">
        ...
        <div className="nav-links-bookvault flex items-center gap-4 ">
           ...
           <div className="flex gap-4">
            <button className="px-4 py-2 border border-blue-500 hover:bg-white hover:text-zinc-800 transition-all duration-300">LogIn</button>
