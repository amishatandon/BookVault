...
import { Link } from "react-router-dom"; // Make sure to import Link if not already imported
import { FaArrowRight } from "react-icons/fa";
const Sidebar = ({ profile }) => {
  if (!profile) {
    return null; // If profile is not yet loaded, return null or a loading indicator
  }

  return (
    <div className="bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-[100%]">
      <div className="flex items-center flex-col justify-center"><img src={profile.avatar} className="h-[14vh]" alt="User Avatar" />
